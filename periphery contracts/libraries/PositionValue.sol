...
// import '@GinsengSwap/v3-core/contracts/libraries/Tick.sol';
...
/// @title Returns information about the token value held in a GinsengSwap V3 NFT
library PositionValue {
    /// @notice Returns the total amounts of token0 and token1, i.e. the sum of fees and principal
    /// that a given nonfungible position manager token is worth
    /// @param positionManager The GinsengSwap V3 NonfungiblePositionManager
