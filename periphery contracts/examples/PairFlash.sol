...
import "../../v3-core/contracts/interfaces/callback/IGinsengSwapV3FlashCallback.sol";
import "../../v3-core/contracts/libraries/LowGasSafeMath.sol";

// import '@GinsengSwap/v3-core/contracts/interfaces/callback/IGinsengSwapV3FlashCallback.sol';
// import '@GinsengSwap/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
/// @notice An example contract using the GinsengSwap V3 flash function
contract PairFlash is IGinsengSwapV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `GinsengSwapV3FlashCallback`
    function initFlash(FlashParams memory params) external {
        PoolAddress.PoolKey memory poolKey =
            PoolAddress.PoolKey({token0: params.token0, token1: params.token1, fee: params.fee1});
        IGinsengSwapV3Pool pool = IGinsengSwapV3Pool(PoolAddress.computeAddress(factory, poolKey));
