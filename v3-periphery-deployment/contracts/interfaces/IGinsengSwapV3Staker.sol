...
// import '@GinsengSwap/v3-periphery/contracts/interfaces/IMulticall.sol';
...
/// @title GinsengSwap V3 Staker Interface
/// @notice Allows staking nonfungible liquidity tokens in exchange for reward tokens
interface IGinsengSwapV3Staker is IERC721Receiver, IMulticall {
    /// @param rewardToken The token being distributed as a reward
    /// @param pool The GinsengSwap V3 pool
    ...
    /// @notice The GinsengSwap V3 Factory
    function factory() external view returns (IGinsengSwapV3Factory);
    ...
    /// @notice Withdraws a GinsengSwap V3 LP token `tokenId` from this contract to the recipient `to`
    ...
    event IncentiveCreated(
        ...
        IGinsengSwapV3Pool indexed pool,
        uint256 startTime,
        uint256 endTime,
        address refundee,
        uint256 reward
    ...
    /// @notice Event emitted when a GinsengSwap V3 LP token has been staked
    /// @param tokenId The unique identifier of an GinsengSwap V3 LP token
    /// @param liquidity The amount of liquidity staked
    /// @param incentiveId The incentive in which the token is staking
    event TokenStaked(uint256 indexed tokenId, bytes32 indexed incentiveId, uint128 liquidity);

    /// @notice Event emitted when a GinsengSwap V3 LP token has been unstaked
    /// @param tokenId The unique identifier of an GinsengSwap V3 LP token
    /// @param incentiveId The incentive in which the token is staking
