...
// import '@GinsengSwap/v3-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IGinsengSwapV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IGinsengSwapV3Pool) {
        return IGinsengSwapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function GinsengSwapV3SwapCallback(
        ...
        IGinsengSwapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IGinsengSwapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
